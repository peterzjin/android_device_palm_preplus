...
static void onSIMReady()
{
     ...
     */
#ifdef PREPLUS_MODEM
    at_send_command("AT+CPMS=\"SM\",\"MT\",\"SM\"",NULL);
    at_send_command("AT+CNMI=1,1,0,0,1", NULL);
#else
...
{
#ifdef PREPLUS_MODEM
    //do not need to ack becasue we get from sim
    return ;
#endif
    int ackSuccess;
    int err;
...
static void onUnsolicited (const char *s, const char *sms_pdu)
{
	...
	//+CMTI: "SM",index
        ...
        //it seem to be index+1 is the real on sim
        index++;
